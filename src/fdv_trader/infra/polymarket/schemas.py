...
def _summarize_payload(payload: Mapping[str, Any], *, max_length: int = 512) -> str:
    try:
        summary = dumps(payload, ensure_ascii=False, sort_keys=True, default=str)
    except TypeError:
