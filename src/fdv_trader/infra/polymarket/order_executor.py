...
from fdv_trader.domain.events import DomainEventType, OutboxEvent, sanitize_raw_response
...
from fdv_trader.infra.outbox.local_queue import DEFAULT_ENQUEUE_TIMEOUT, LocalOutbox
    ...
    def __init__(
        ...
        *,
        ...
        self._thread_pool = thread_pool or ThreadPoolExecutor(
            max_workers=4,
            thread_name_prefix="fdv-order-executor",
        )
