...
from fdv_trader.domain.events import sanitize_raw_response
from fdv_trader.observability.trace import current_trace_id

_LOG_CONTEXT: ContextVar[dict[str, Any]] = ContextVar("fdv_log_context", default={})
