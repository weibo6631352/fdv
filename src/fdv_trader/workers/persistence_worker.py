...
from fdv_trader.domain.events import AuditEvent, DomainEventType, OutboxEvent
    ...
    def _build_market_record(self, event: OutboxEvent, payload: Mapping[str, Any]) -> dict[str, Any]:
        ...
        if market is None:
            market = {
                ...
                "yes_token_id": _safe_first_payload_value(payload, "yes_token_id", "yesTokenId"),
                "no_token_id": _safe_first_payload_value(payload, "no_token_id", "noTokenId"),
