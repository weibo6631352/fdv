...
| [Reconcile Worker](./03-realtime-runtime/05-reconcile-worker/README.md) | M2 | W18 | done | Polymarket clients、Position、Order Executor | 已完成 `app/reconcile_service.py`、`workers/reconcile_worker.py`、`main.py` 的 reconcile 计划、P2 扫描、P1/P0 修复升级和 runtime wiring，未运行验证测试 |
